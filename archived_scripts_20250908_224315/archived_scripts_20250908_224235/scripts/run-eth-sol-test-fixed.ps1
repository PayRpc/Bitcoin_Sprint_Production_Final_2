...
$ethSolTestPath = Join-Path $scriptsDir "eth-sol-test-fixed.ps1"
...
$prometheusParam = if ($NoPrometheus) { "-NoPrometheus" } else { "" }
$command = "& '$ethSolTestPath' -DurationSec $duration $verboseParam $prometheusParam"
